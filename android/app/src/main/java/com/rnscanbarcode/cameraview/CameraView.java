...
public class CameraView extends FrameLayout {
    ...
    com.rnscanbarcode.cameraview.CameraViewImpl mImpl;
    ...
    private final com.rnscanbarcode.cameraview.DisplayOrientationDetector mDisplayOrientationDetector;
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr, boolean fallbackToOldApi) {
        ...
        // Internal setup
        final com.rnscanbarcode.cameraview.PreviewImpl preview = createPreviewImpl(context);
        mCallbacks = new CallbackBridge();
        if (fallbackToOldApi || Build.VERSION.SDK_INT < 21 || com.rnscanbarcode.cameraview.Camera2.isLegacy(context)) {
            mImpl = new com.rnscanbarcode.cameraview.Camera1(mCallbacks, preview, mBgHandler);
        } else if (Build.VERSION.SDK_INT < 23) {
            mImpl = new com.rnscanbarcode.cameraview.Camera2(mCallbacks, preview, context, mBgHandler);
        } else {
            mImpl = new com.rnscanbarcode.cameraview.Camera2Api23(mCallbacks, preview, context, mBgHandler);
        }

        // Display orientation detector
        mDisplayOrientationDetector = new com.rnscanbarcode.cameraview.DisplayOrientationDetector(context) {
            @Override
    ...
    @NonNull
    private com.rnscanbarcode.cameraview.PreviewImpl createPreviewImpl(Context context) {
        com.rnscanbarcode.cameraview.PreviewImpl preview;
        if (Build.VERSION.SDK_INT < 14) {
            preview = new com.rnscanbarcode.cameraview.SurfaceViewPreview(context, this);
        } else {
            preview = new com.rnscanbarcode.cameraview.TextureViewPreview(context, this);
        }
        return preview;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mAdjustViewBounds) {
            ...
            if (widthMode == MeasureSpec.EXACTLY && heightMode != MeasureSpec.EXACTLY) {
                final com.rnscanbarcode.cameraview.AspectRatio ratio = getAspectRatio();
                assert ratio != null;
        ...
        com.rnscanbarcode.cameraview.AspectRatio ratio = getAspectRatio();
    ...
    public void setUsingCamera2Api(boolean useCamera2) {
        ...
        if (useCamera2 && !com.rnscanbarcode.cameraview.Camera2.isLegacy(mContext)) {
            if (wasOpened) {
                stop();
            }
            if (Build.VERSION.SDK_INT < 23) {
                mImpl = new com.rnscanbarcode.cameraview.Camera2(mCallbacks, mImpl.mPreview, mContext, mBgHandler);
            } else {
                mImpl = new com.rnscanbarcode.cameraview.Camera2Api23(mCallbacks, mImpl.mPreview, mContext, mBgHandler);
            }

            onRestoreInstanceState(state);
        } else {
            if (mImpl instanceof com.rnscanbarcode.cameraview.Camera1) {
                return;
            }
            ...
            mImpl = new com.rnscanbarcode.cameraview.Camera1(mCallbacks, mImpl.mPreview, mBgHandler);
        }
        if(wasOpened){
            start();
        }
     ...
     */
    public Set<com.rnscanbarcode.cameraview.AspectRatio> getSupportedAspectRatios() {
     ...
     *
     * @param ratio The {@link com.rnscanbarcode.cameraview.AspectRatio} to be set.
     */
    public void setAspectRatio(@NonNull com.rnscanbarcode.cameraview.AspectRatio ratio) {
     ...
     *
     * @return The current {@link com.rnscanbarcode.cameraview.AspectRatio}. Can be {@code null} if no camera is opened yet.
     */
    @Nullable
    public com.rnscanbarcode.cameraview.AspectRatio getAspectRatio() {
     ...
     *
     * @param ratio {@link com.rnscanbarcode.cameraview.AspectRatio} for which the available image sizes will be returned.
     */
    public SortedSet<com.rnscanbarcode.cameraview.Size> getAvailablePictureSizes(@NonNull com.rnscanbarcode.cameraview.AspectRatio ratio) {
     ...
     *
     * @param size The {@link com.rnscanbarcode.cameraview.Size} to be set.
     */
    public void setPictureSize(@NonNull com.rnscanbarcode.cameraview.Size size) {
     ...
     */
    public com.rnscanbarcode.cameraview.Size getPictureSize() {
     ...
     * {@link Callback#onPictureTaken(com.rnscanbarcode.cameraview.CameraView, byte[], int)}.
     */
     ...
     * {@link Callback#onVideoRecorded(com.rnscanbarcode.cameraview.CameraView, String, int, int)}.
     ...
     *
     * fires {@link Callback#onRecordingStart(com.rnscanbarcode.cameraview.CameraView, String, int, int)} and {@link Callback#onRecordingEnd(com.rnscanbarcode.cameraview.CameraView)}.
     */
    ...
    private class CallbackBridge implements com.rnscanbarcode.cameraview.CameraViewImpl.Callback {
        ...
        public void onCameraOpened() {
            ...
            for (Callback callback : mCallbacks) {
                callback.onCameraOpened(com.rnscanbarcode.cameraview.CameraView.this);
            }
        }
        ...
        public void onCameraClosed() {
            for (Callback callback : mCallbacks) {
                callback.onCameraClosed(com.rnscanbarcode.cameraview.CameraView.this);
            }
        }
        ...
        public void onPictureTaken(byte[] data, int deviceOrientation) {
            for (Callback callback : mCallbacks) {
                callback.onPictureTaken(com.rnscanbarcode.cameraview.CameraView.this, data, deviceOrientation);
            }
        }
        ...
        public void onRecordingStart(String path, int videoOrientation, int deviceOrientation) {
            for (Callback callback : mCallbacks) {
                callback.onRecordingStart(com.rnscanbarcode.cameraview.CameraView.this, path, videoOrientation, deviceOrientation);
            }
        }
        ...
        public void onRecordingEnd() {
            for (Callback callback : mCallbacks) {
                callback.onRecordingEnd(com.rnscanbarcode.cameraview.CameraView.this);
            }
        }
        ...
        public void onVideoRecorded(String path, int videoOrientation, int deviceOrientation) {
            for (Callback callback : mCallbacks) {
                callback.onVideoRecorded(com.rnscanbarcode.cameraview.CameraView.this, path, videoOrientation, deviceOrientation);
            }
        }
        ...
        public void onFramePreview(byte[] data, int width, int height, int orientation) {
            for (Callback callback : mCallbacks) {
                callback.onFramePreview(com.rnscanbarcode.cameraview.CameraView.this, data, width, height, orientation);
            }
        }
        ...
        public void onMountError() {
            for (Callback callback : mCallbacks) {
                callback.onMountError(com.rnscanbarcode.cameraview.CameraView.this);
            }
        }
    ...
    protected static class SavedState extends BaseSavedState {
        ...
        com.rnscanbarcode.cameraview.AspectRatio ratio;
        ...
        com.rnscanbarcode.cameraview.Size pictureSize;
    ...
    /**
     * Callback for monitoring events about {@link com.rnscanbarcode.cameraview.CameraView}.
     */
    ...
    public abstract static class Callback {
         ...
         *
         * @param cameraView The associated {@link com.rnscanbarcode.cameraview.CameraView}.
         */
        public void onCameraOpened(com.rnscanbarcode.cameraview.CameraView cameraView) {}
         ...
         * @param cameraView The associated {@link com.rnscanbarcode.cameraview.CameraView}.
         */
        public void onCameraClosed(com.rnscanbarcode.cameraview.CameraView cameraView) {}
         ...
         */
        public void onPictureTaken(com.rnscanbarcode.cameraview.CameraView cameraView, byte[] data, int deviceOrientation) {}
         ...
         */
        public void onRecordingStart(com.rnscanbarcode.cameraview.CameraView cameraView, String path, int videoOrientation, int deviceOrientation) {}
         ...
         * @param path       Path to recoredd video file.
         */
        public void onRecordingEnd(com.rnscanbarcode.cameraview.CameraView cameraView){}
         ...
         * @param path       Path to recoredd video file.
         */
        public void onVideoRecorded(com.rnscanbarcode.cameraview.CameraView cameraView, String path, int videoOrientation, int deviceOrientation) {}

        public void onFramePreview(com.rnscanbarcode.cameraview.CameraView cameraView, byte[] data, int width, int height, int orientation) {}

        public void onMountError(com.rnscanbarcode.cameraview.CameraView cameraView) {}
    }
