...
import com.rnscanbarcode.RNCamera.camera.utils.ObjectUtils;
...
class Camera1 extends com.rnscanbarcode.cameraview.CameraViewImpl implements MediaRecorder.OnInfoListener,
    ...
    static {
        FLASH_MODES.put(com.rnscanbarcode.cameraview.Constants.FLASH_OFF, Camera.Parameters.FLASH_MODE_OFF);
        FLASH_MODES.put(com.rnscanbarcode.cameraview.Constants.FLASH_ON, Camera.Parameters.FLASH_MODE_ON);
        FLASH_MODES.put(com.rnscanbarcode.cameraview.Constants.FLASH_TORCH, Camera.Parameters.FLASH_MODE_TORCH);
        FLASH_MODES.put(com.rnscanbarcode.cameraview.Constants.FLASH_AUTO, Camera.Parameters.FLASH_MODE_AUTO);
        FLASH_MODES.put(com.rnscanbarcode.cameraview.Constants.FLASH_RED_EYE, Camera.Parameters.FLASH_MODE_RED_EYE);
    }

    private static final SparseArrayCompat<String> WB_MODES = new SparseArrayCompat<>();

    static {
      WB_MODES.put(com.rnscanbarcode.cameraview.Constants.WB_AUTO, Camera.Parameters.WHITE_BALANCE_AUTO);
      WB_MODES.put(com.rnscanbarcode.cameraview.Constants.WB_CLOUDY, Camera.Parameters.WHITE_BALANCE_CLOUDY_DAYLIGHT);
      WB_MODES.put(com.rnscanbarcode.cameraview.Constants.WB_SUNNY, Camera.Parameters.WHITE_BALANCE_DAYLIGHT);
      WB_MODES.put(com.rnscanbarcode.cameraview.Constants.WB_SHADOW, Camera.Parameters.WHITE_BALANCE_SHADE);
      WB_MODES.put(com.rnscanbarcode.cameraview.Constants.WB_FLUORESCENT, Camera.Parameters.WHITE_BALANCE_FLUORESCENT);
      WB_MODES.put(com.rnscanbarcode.cameraview.Constants.WB_INCANDESCENT, Camera.Parameters.WHITE_BALANCE_INCANDESCENT);
    }
    ...
    private final com.rnscanbarcode.cameraview.SizeMap mPreviewSizes = new com.rnscanbarcode.cameraview.SizeMap();

    private boolean mIsPreviewActive = false;
    private boolean mShowingPreview = true; // preview enabled by default

    private final com.rnscanbarcode.cameraview.SizeMap mPictureSizes = new com.rnscanbarcode.cameraview.SizeMap();

    private com.rnscanbarcode.cameraview.Size mPictureSize;

    private com.rnscanbarcode.cameraview.AspectRatio mAspectRatio;
    ...
    private int mOrientation = com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO;
    ...
    Camera1(Callback callback, com.rnscanbarcode.cameraview.PreviewImpl preview, Handler bgHandler) {
        super(callback, preview, bgHandler);

        preview.setCallback(new com.rnscanbarcode.cameraview.PreviewImpl.Callback() {
            @Override
            public void onSurfaceChanged() {
                ...
                synchronized(com.rnscanbarcode.cameraview.Camera1.this){
        ...
        synchronized(this){
            if (mMediaRecorder != null) {
                ...
                if (mIsRecording.get()) {
                    ...
                    mCallback.onVideoRecorded(mVideoPath, mOrientation != com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO ? mOrientation : deviceOrientation, deviceOrientation);
                }
            }
    ...
    @Override
    Set<com.rnscanbarcode.cameraview.AspectRatio> getSupportedAspectRatios() {
        com.rnscanbarcode.cameraview.SizeMap idealAspectRatios = mPreviewSizes;
        for (com.rnscanbarcode.cameraview.AspectRatio aspectRatio : idealAspectRatios.ratios()) {
    ...
    @Override
    SortedSet<com.rnscanbarcode.cameraview.Size> getAvailablePictureSizes(com.rnscanbarcode.cameraview.AspectRatio ratio) {
    ...
    private com.rnscanbarcode.cameraview.Size getBestSizeMatch(int desiredWidth, int desiredHeight, SortedSet<com.rnscanbarcode.cameraview.Size> sizes) {
        if(sizes == null || sizes.isEmpty()){
            return null;
        }

        com.rnscanbarcode.cameraview.Size result = sizes.last();

        // iterate from smallest to largest, and stay with the closest-biggest match
        if(desiredWidth != 0 && desiredHeight != 0){
            for (com.rnscanbarcode.cameraview.Size size : sizes) {
    ...
    @Override
    void setPictureSize(com.rnscanbarcode.cameraview.Size size) {
    ...
    @Override
    com.rnscanbarcode.cameraview.Size getPictureSize() {
        return mPictureSize;
    }

    @Override
    boolean setAspectRatio(final com.rnscanbarcode.cameraview.AspectRatio ratio) {
        if (mAspectRatio == null || !isCameraOpened()) {
            // Handle this later when camera is opened
            mAspectRatio = ratio;
            return true;
        } else if (!mAspectRatio.equals(ratio)) {
            final Set<com.rnscanbarcode.cameraview.Size> sizes = mPreviewSizes.sizes(ratio);
            if (sizes == null) {
    ...
    @Override
    com.rnscanbarcode.cameraview.AspectRatio getAspectRatio() {
        return mAspectRatio;
    }
    ...
    int orientationEnumToRotation(int orientation) {
        switch(orientation) {
            case com.rnscanbarcode.cameraview.Constants.ORIENTATION_UP:
                return 0;
            case com.rnscanbarcode.cameraview.Constants.ORIENTATION_DOWN:
                return 180;
            case com.rnscanbarcode.cameraview.Constants.ORIENTATION_LEFT:
                return 270;
            case com.rnscanbarcode.cameraview.Constants.ORIENTATION_RIGHT:
                return 90;
            default:
                return com.rnscanbarcode.cameraview.Constants.ORIENTATION_UP;
        }
    }
    ...
    int displayOrientationToOrientationEnum(int rotation) {
        switch (rotation) {
            case 0:
                return com.rnscanbarcode.cameraview.Constants.ORIENTATION_UP;
            case 90:
                return com.rnscanbarcode.cameraview.Constants.ORIENTATION_RIGHT;
            case 180:
                return com.rnscanbarcode.cameraview.Constants.ORIENTATION_DOWN;
            case 270:
                return com.rnscanbarcode.cameraview.Constants.ORIENTATION_LEFT;
            default:
                return 1;
        }
    }
    ...
    void takePictureInternal(final ReadableMap options) {
        ...
        if (!mIsRecording.get() && isPictureCaptureInProgress.compareAndSet(false, true)) {
            ...
            try{
                if (options.hasKey("orientation") && options.getInt("orientation") != com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO) {
                ...
                mCamera.takePicture(null, null, null, new Camera.PictureCallback() {
                    ...
                    public void onPictureTaken(byte[] data, Camera camera) {
                            ...
                            if(mCamera != null){
                                if (options.hasKey("pauseAfterCapture") && !options.getBoolean("pauseAfterCapture")) {
                                    try{
                                        ...
                                        mIsPreviewActive = true;
                                        if (mIsScanning) {
                                            mCamera.setPreviewCallback(com.rnscanbarcode.cameraview.Camera1.this);
                                        }
                                    }
                                    catch(Exception e){
                                        mIsPreviewActive = false;
                        ...
                        mOrientation = com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO;
    ...
    boolean record(String path, int maxDuration, int maxFileSize, boolean recordAudio, CamcorderProfile profile, int orientation, int fps) {
        ...
        if (!isPictureCaptureInProgress.get() && mIsRecording.compareAndSet(false, true)) {
            if (orientation != com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO) {
            ...
            try {
                ...
                int deviceOrientation = displayOrientationToOrientationEnum(mDeviceOrientation);
                mCallback.onRecordingStart(path, mOrientation != com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO ? mOrientation : deviceOrientation, deviceOrientation);
    ...
    void setDeviceOrientation(final int deviceOrientation) {
        synchronized(this){
            ...
            if (isCameraOpened() && mOrientation == com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO && !mIsRecording.get() && !isPictureCaptureInProgress.get()) {
                try{
    ...
    @Override
    public com.rnscanbarcode.cameraview.Size getPreviewSize() {
        Camera.Size cameraSize = mCameraParameters.getPreviewSize();
        return new com.rnscanbarcode.cameraview.Size(cameraSize.width, cameraSize.height);
    }
    ...
    private boolean openCamera() {
        ...
        try {
            ...
            for (Camera.Size size : mCameraParameters.getSupportedPreviewSizes()) {
                mPreviewSizes.add(new com.rnscanbarcode.cameraview.Size(size.width, size.height));
            }

            // Supported picture sizes;
            mPictureSizes.clear();
            for (Camera.Size size : mCameraParameters.getSupportedPictureSizes()) {
                mPictureSizes.add(new com.rnscanbarcode.cameraview.Size(size.width, size.height));
            }
            ...
            for (com.rnscanbarcode.cameraview.AspectRatio aspectRatio : mPreviewSizes.ratios()) {
                if (mPictureSizes.sizes(aspectRatio) == null) {
            ...
            if (mAspectRatio == null) {
                mAspectRatio = com.rnscanbarcode.cameraview.Constants.DEFAULT_ASPECT_RATIO;
            }
    ...
    private com.rnscanbarcode.cameraview.AspectRatio chooseAspectRatio() {
        com.rnscanbarcode.cameraview.AspectRatio r = null;
        for (com.rnscanbarcode.cameraview.AspectRatio ratio : mPreviewSizes.ratios()) {
            r = ratio;
            if (ratio.equals(com.rnscanbarcode.cameraview.Constants.DEFAULT_ASPECT_RATIO)) {
                return ratio;
            }
        }
        return r;
    ...
    void adjustCameraParameters() {
        SortedSet<com.rnscanbarcode.cameraview.Size> sizes = mPreviewSizes.sizes(mAspectRatio);
        ...
        com.rnscanbarcode.cameraview.Size size = chooseOptimalSize(sizes);
        com.rnscanbarcode.cameraview.Size pictureSize = null;
        ...
        if (mOrientation != com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO) {
    ...
    private com.rnscanbarcode.cameraview.Size chooseOptimalSize(SortedSet<com.rnscanbarcode.cameraview.Size> sizes) {
        ...
        com.rnscanbarcode.cameraview.Size result = null;
        for (com.rnscanbarcode.cameraview.Size size : sizes) { // Iterate from small to large
            if (desiredWidth <= size.getWidth() && desiredHeight <= size.getHeight()) {
                return size;
    ...
    private boolean isLandscape(int orientationDegrees) {
        return (orientationDegrees == com.rnscanbarcode.cameraview.Constants.LANDSCAPE_90 ||
                orientationDegrees == com.rnscanbarcode.cameraview.Constants.LANDSCAPE_270);
    }
    ...
    private void setUpMediaRecorder(String path, int maxDuration, int maxFileSize, boolean recordAudio, CamcorderProfile profile, int fps) {
        ...
        mMediaRecorder.setOrientationHint(calcCameraRotation(mOrientation != com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO ? orientationEnumToRotation(mOrientation) : mDeviceOrientation));
    ...
    private void stopMediaRecorder() {
        ...
        synchronized(this){
            ...
            if (mVideoPath == null || !new File(mVideoPath).exists()) {
                mCallback.onVideoRecorded(null, mOrientation != com.rnscanbarcode.cameraview.Constants.ORIENTATION_AUTO ? mOrientation : deviceOrientation, deviceOrientation);
                return;
            }
