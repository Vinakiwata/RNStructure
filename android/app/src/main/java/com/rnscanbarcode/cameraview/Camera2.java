...
@TargetApi(21)
class Camera2 extends com.rnscanbarcode.cameraview.CameraViewImpl implements MediaRecorder.OnInfoListener, MediaRecorder.OnErrorListener {
    ...
    private com.rnscanbarcode.cameraview.AspectRatio mAspectRatio = Constants.DEFAULT_ASPECT_RATIO;

    private com.rnscanbarcode.cameraview.AspectRatio mInitialRatio;
    ...
    Camera2(Callback callback, com.rnscanbarcode.cameraview.PreviewImpl preview, Context context, Handler bgHandler) {
        ...
        mPreview.setCallback(new com.rnscanbarcode.cameraview.PreviewImpl.Callback() {
            @Override
    ...
    @Override
    boolean setAspectRatio(com.rnscanbarcode.cameraview.AspectRatio ratio) {
    ...
    boolean record(String path, int maxDuration, int maxFileSize, boolean recordAudio, CamcorderProfile profile, int orientation, int fps) {
        if (!mIsRecording) {
            ...
            try {
                ...
                com.rnscanbarcode.cameraview.Size size = chooseOptimalSize();
    ...
    private void collectCameraInfo() {
        ...
        for (android.util.Size size : map.getOutputSizes(mPreview.getOutputClass())) {
            ...
            if (width <= MAX_PREVIEW_WIDTH && height <= MAX_PREVIEW_HEIGHT) {
                mPreviewSizes.add(new com.rnscanbarcode.cameraview.Size(width, height));
            }
        }
        mPictureSizes.clear();
    ...
    protected void collectPictureSizes(com.rnscanbarcode.cameraview.SizeMap sizes, StreamConfigurationMap map) {
        for (android.util.Size size : map.getOutputSizes(mImageFormat)) {
            mPictureSizes.add(new com.rnscanbarcode.cameraview.Size(size.getWidth(), size.getHeight()));
        }
    }
    ...
    private void prepareScanImageReader() {
        ...
        com.rnscanbarcode.cameraview.Size largest = mPreviewSizes.sizes(mAspectRatio).last();
    ...
    void startCaptureSession() {
        ...
        com.rnscanbarcode.cameraview.Size previewSize = chooseOptimalSize();
    ...
    public com.rnscanbarcode.cameraview.Size getPreviewSize() {
        return new com.rnscanbarcode.cameraview.Size(mPreview.getWidth(), mPreview.getHeight());
    }
     ...
     */
    private com.rnscanbarcode.cameraview.Size chooseOptimalSize() {
        ...
        SortedSet<com.rnscanbarcode.cameraview.Size> candidates = mPreviewSizes.sizes(mAspectRatio);

        // Pick the smallest of those big enough
        for (com.rnscanbarcode.cameraview.Size size : candidates) {
