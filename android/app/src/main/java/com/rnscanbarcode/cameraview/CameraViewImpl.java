...
abstract class CameraViewImpl {
    ...
    protected final com.rnscanbarcode.cameraview.PreviewImpl mPreview;
    ...
    CameraViewImpl(Callback callback, com.rnscanbarcode.cameraview.PreviewImpl preview, Handler bgHandler) {
        mCallback = callback;
        mPreview = preview;
    ...
    abstract Set<com.rnscanbarcode.cameraview.AspectRatio> getSupportedAspectRatios();

    abstract List<Properties> getCameraIds();

    abstract SortedSet<com.rnscanbarcode.cameraview.Size> getAvailablePictureSizes(com.rnscanbarcode.cameraview.AspectRatio ratio);

    abstract void setPictureSize(com.rnscanbarcode.cameraview.Size size);

    abstract com.rnscanbarcode.cameraview.Size getPictureSize();

    /**
     * @return {@code true} if the aspect ratio was changed.
     */
    abstract boolean setAspectRatio(com.rnscanbarcode.cameraview.AspectRatio ratio);

    abstract com.rnscanbarcode.cameraview.AspectRatio getAspectRatio();
    ...
    abstract public com.rnscanbarcode.cameraview.Size getPreviewSize();
