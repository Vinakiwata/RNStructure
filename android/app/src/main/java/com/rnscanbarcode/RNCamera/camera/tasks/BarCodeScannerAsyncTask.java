...
public class BarCodeScannerAsyncTask extends android.os.AsyncTask<Void, Void, Result> {
  ...
  private int mWidth;
  private int mHeight;
  private com.rnscanbarcode.RNCamera.camera.tasks.BarCodeScannerAsyncTaskDelegate mDelegate;
  ...
  public BarCodeScannerAsyncTask(
          com.rnscanbarcode.RNCamera.camera.tasks.BarCodeScannerAsyncTaskDelegate delegate,
