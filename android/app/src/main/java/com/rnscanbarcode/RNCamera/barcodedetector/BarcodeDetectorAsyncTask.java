...
import com.rnscanbarcode.RNCamera.camera.tasks.BarcodeDetectorAsyncTaskDelegate;
...
import com.rnscanbarcode.RNCamera.frame.RNFrameFactory;
...
public class BarcodeDetectorAsyncTask extends android.os.AsyncTask<Void, Void, SparseArray<Barcode>> {
  ...
  private com.rnscanbarcode.RNCamera.barcodedetector.RNBarcodeDetector mBarcodeDetector;
  ...
  public BarcodeDetectorAsyncTask(
          ...
          com.rnscanbarcode.RNCamera.barcodedetector.RNBarcodeDetector barcodeDetector,
          byte[] imageData,
          int width,
          int height,
          int rotation,
  ...
  private WritableArray serializeEventData(SparseArray<Barcode> barcodes) {
    ...
    for (int i = 0; i < barcodes.size(); i++) {
      ...
      serializedBarcode.putString("type", com.rnscanbarcode.RNCamera.barcodedetector.BarcodeFormatUtils.get(barcode.format));
