...
public class TouchEvent extends Event<TouchEvent> {
  ...
  public static com.rnscanbarcode.RNCamera.camera.events.TouchEvent obtain(int viewTag, boolean isDoubleTap, int x, int y) {
    com.rnscanbarcode.RNCamera.camera.events.TouchEvent event = EVENTS_POOL.acquire();
    if (event == null) {
      event = new com.rnscanbarcode.RNCamera.camera.events.TouchEvent();
    }
