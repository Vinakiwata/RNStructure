...
import com.rnscanbarcode.RNCamera.camera.tasks.*;
import com.rnscanbarcode.cameraview.CameraView;
import com.rnscanbarcode.RNCamera.barcodedetector.RNBarcodeDetector;
import com.rnscanbarcode.RNCamera.barcodedetector.BarcodeDetectorAsyncTask;
import com.rnscanbarcode.RNCamera.camera.utils.RNFileUtils;
...
public class RNCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate,/* FaceDetectorAsyncTaskDelegate,*/
  ...
  public RNCameraView(ThemedReactContext themedReactContext) {
    ...
    addCallback(new Callback() {
      ...
      public void onCameraOpened(CameraView cameraView) {
        com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitCameraReadyEvent(cameraView);
      }

      @Override
      public void onMountError(CameraView cameraView) {
        com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitMountErrorEvent(cameraView, "Camera view threw an error - component could not be rendered.");
      }
      ...
      public void onPictureTaken(CameraView cameraView, final byte[] data, int deviceOrientation) {
        ...
        if(Build.VERSION.SDK_INT >= 11/*HONEYCOMB*/) {
          new ResolveTakenPictureAsyncTask(data, promise, options, cacheDirectory, deviceOrientation, com.rnscanbarcode.RNCamera.camera.RNCameraView.this)
                  .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        } else {
          new ResolveTakenPictureAsyncTask(data, promise, options, cacheDirectory, deviceOrientation, com.rnscanbarcode.RNCamera.camera.RNCameraView.this)
                  .execute();
        }
        com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitPictureTakenEvent(cameraView);
      }
      ...
      public void onRecordingStart(CameraView cameraView, String path, int videoOrientation, int deviceOrientation) {
        ...
        com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitRecordingStartEvent(cameraView, result);
      }

      @Override
      public void onRecordingEnd(CameraView cameraView) {
        com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitRecordingEndEvent(cameraView);
      }
      ...
      public void onFramePreview(CameraView cameraView, byte[] data, int width, int height, int rotation) {
        int correctRotation = com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.getCorrectCameraRotation(rotation, getFacing(), getCameraOrientation());
  ...
  public void takePicture(final ReadableMap options, final Promise promise, final File cacheDirectory) {
    mBgHandler.post(new Runnable() {
      ...
      public void run() {
        ...
        try {
          com.rnscanbarcode.RNCamera.camera.RNCameraView.super.takePicture(options);
        } catch (Exception e) {
  ...
  public void onPictureSaved(WritableMap response) {
    com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitPictureSavedEvent(this, response);
  }
      ...
      public void run() {
        try {
          ...
          if (options.hasKey("quality")) {
            profile = com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.getCamcorderProfile(options.getInt("quality"));
          }
          ...
          int orientation = com.rnscanbarcode.RNCamera.camera.Constants.ORIENTATION_AUTO;
          if (options.hasKey("orientation")) {
            orientation = options.getInt("orientation");
          }

          if (com.rnscanbarcode.RNCamera.camera.RNCameraView.super.record(path, maxDuration * 1000, maxFileSize, recordAudio, profile, orientation, fps)) {
            mIsRecording = true;
  ...
  private void initBarcodeReader() {
    ...
    if (mBarCodeTypes != null) {
      for (String code : mBarCodeTypes) {
        String formatString = (String) com.rnscanbarcode.RNCamera.camera.CameraModule.VALID_BARCODE_TYPES.get(code);
  ...
  public void setShouldScanBarCodes(boolean shouldScanBarCodes) {
    ...
    setScanning( mShouldGoogleDetectBarcodes || mShouldScanBarCodes);
  }
  ...
  public void onBarCodeRead(Result barCode, int width, int height, byte[] imageData) {
    ...
    com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitBarCodeReadEvent(this, barCode, width, height, compressedImage);
  }
  ...
  public void onBarcodesDetected(WritableArray barcodesDetected, int width, int height, byte[] imageData) {
    ...
    com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitBarcodesDetectedEvent(this, barcodesDetected, compressedImage);
  }
  ...
  public void onBarcodeDetectionError(RNBarcodeDetector barcodeDetector) {
    ...
    com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitBarcodeDetectionErrorEvent(this, barcodeDetector);
  }
  ...
  * End Text Recognition */
  ...
  public void onHostResume() {
    if (hasCameraPermissions()) {
      ...
      com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitMountErrorEvent(this, "Camera permissions not granted - component could not be rendered.");
    }
  }
  ...
  private GestureDetector.SimpleOnGestureListener onGestureListener = new GestureDetector.SimpleOnGestureListener(){
    ...
    public boolean onSingleTapUp(MotionEvent e) {
      com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitTouchEvent(com.rnscanbarcode.RNCamera.camera.RNCameraView.this,false,scalePosition(e.getX()),scalePosition(e.getY()));
      return true;
    }

    @Override
    public boolean onDoubleTap(MotionEvent e) {
      com.rnscanbarcode.RNCamera.camera.RNCameraViewHelper.emitTouchEvent(com.rnscanbarcode.RNCamera.camera.RNCameraView.this,true,scalePosition(e.getX()),scalePosition(e.getY()));
      return true;
    }
  };
