...
import com.rnscanbarcode.RNCamera.camera.events.*;
...
public class RNCameraViewHelper {
  ...
  private static boolean rotationIsLandscape(int rotation) {
    return (rotation == com.rnscanbarcode.RNCamera.camera.Constants.LANDSCAPE_90 ||
            rotation == com.rnscanbarcode.RNCamera.camera.Constants.LANDSCAPE_270);
  }

  private static int getCamcorderProfileQualityFromCameraModuleConstant(int quality) {
    switch (quality) {
      case com.rnscanbarcode.RNCamera.camera.CameraModule.VIDEO_2160P:
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
          return CamcorderProfile.QUALITY_2160P;
        }
      case com.rnscanbarcode.RNCamera.camera.CameraModule.VIDEO_1080P:
        return CamcorderProfile.QUALITY_1080P;
      case com.rnscanbarcode.RNCamera.camera.CameraModule.VIDEO_720P:
        return CamcorderProfile.QUALITY_720P;
      case com.rnscanbarcode.RNCamera.camera.CameraModule.VIDEO_480P:
        return CamcorderProfile.QUALITY_480P;
      case com.rnscanbarcode.RNCamera.camera.CameraModule.VIDEO_4x3:
        return CamcorderProfile.QUALITY_480P;
    }
  ...
  public static CamcorderProfile getCamcorderProfile(int quality) {
    ...
    if (CamcorderProfile.hasProfile(camcorderQuality)) {
      ...
      if (quality == com.rnscanbarcode.RNCamera.camera.CameraModule.VIDEO_4x3) {
